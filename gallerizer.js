;(function(global){
	...
	if (typeof GALLERIZER_NOW === 'undefined') {
	  GALLERIZER_NOW = function () {
	    return +new Date();
	  };
	}

	if (typeof GALLERIZER === 'undefined') {
	  var global = (function(){return this;})();
	}


	var makeGallerizerObject = function($,tools){
	...
	if (typeof exports === 'object') {
		// nodejs
		module.exports = makeGallerizerObject($,tools);
	} else if (typeof define === 'function' && define.amd) {
		// AMD
		define(['jQuery'],function(){
			console.log('gallerizerdefine')
			return makeGallerizerObject.apply(null,arguments);
		});
	} else if (typeof global.gallerizer === 'undefined') {
		// Browser: Make `Tweenable` globally accessible.
		global.gallerizer = makeGallerizerObject($,tools);
	}
